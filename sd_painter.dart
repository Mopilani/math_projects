...
void main(List<String> args) {
  ...
  try {
    ...
    for (var i = 0; i < (loops ??= 4400); i++) {
      ...
      D3Ball(
        def1: rotat_on_y_2args,
        def2: rotat_on_x_2args,
        x_rotation_on_y: x_rotation_value,
        y_rotation_on_x: x_rotation_value,
        z_rotation_on_y: x_rotation_value,
      ...
      // add3DShape(
      //   x_rotation_on_y: y_rotation_value,
...
D3Ball(
  ...
  //   def1: def1,
  //   def2: def2,
  //   char: _coloredString('6', colorNumber: 36),
  ...
  //   def1: def1,
  //   def2: def2,
  //   char: _coloredString('5', colorNumber: 35),
  //   x_rotation_on_y: y_rotation_on_x * 8,
  //   y_rotation_on_x: y_rotation_on_x * 2,
  //   z_rotation_on_y: z_rotation_on_y,
  //   rotated_on_x: rotated_on_x,
  //   rotated_on_y: rotated_on_y,
  //   framPixels: framPixels,
  ...
  //   def2: def2,
  //   char: _coloredString('5', colorNumber: 35),
  //   x_rotation_on_y: y_rotation_on_x * 6,
  //   y_rotation_on_x: y_rotation_on_x * 4,
  //   z_rotation_on_y: z_rotation_on_y,
  //   rotated_on_x: rotated_on_x,
  //   rotated_on_y: rotated_on_y,
  //   framPixels: framPixels,
  ...
  //   def2: def2,
  //   char: _coloredString('5', colorNumber: 35),
  //   x_rotation_on_y: y_rotation_on_x * 4,
  //   y_rotation_on_x: y_rotation_on_x * 6,
  //   z_rotation_on_y: z_rotation_on_y,
  //   rotated_on_x: rotated_on_x,
  //   rotated_on_y: rotated_on_y,
  //   framPixels: framPixels,
  ...
  add3DShape(
    ...
    def2: def2,
    char: _coloredString('5', colorNumber: 35),
    x_rotation_on_y: x_rotation_on_y * y_rotation_on_x / 30,
    y_rotation_on_x: y_rotation_on_x * x_rotation_on_y / 30,
    z_rotation_on_y: z_rotation_on_y,
    rotated_on_x: rotated_on_x,
    rotated_on_y: rotated_on_y,
    framPixels: framPixels,
  ...
  add3DShape(
    ...
    def2: def2,
    char: _coloredString('5', colorNumber: 35),
    x_rotation_on_y: x_rotation_on_y * y_rotation_on_x / 45,
    y_rotation_on_x: y_rotation_on_x * x_rotation_on_y / 45,
    z_rotation_on_y: z_rotation_on_y,
    rotated_on_x: rotated_on_x,
    rotated_on_y: rotated_on_y,
    framPixels: framPixels,
  ...
  add3DShape(
    ...
    def2: def2,
    char: _coloredString('5', colorNumber: 35),
    x_rotation_on_y: x_rotation_on_y * y_rotation_on_x / 75,
    y_rotation_on_x: y_rotation_on_x * x_rotation_on_y / 75,
    z_rotation_on_y: z_rotation_on_y,
    rotated_on_x: rotated_on_x,
    rotated_on_y: rotated_on_y,
    framPixels: framPixels,
  ...
  add3DShape(
    ...
    def2: def2,
    char: _coloredString('5', colorNumber: 35),
    x_rotation_on_y: x_rotation_on_y * y_rotation_on_x / 90,
    y_rotation_on_x: y_rotation_on_x * x_rotation_on_y / 90,
    z_rotation_on_y: z_rotation_on_y,
    rotated_on_x: rotated_on_x,
    rotated_on_y: rotated_on_y,
    framPixels: framPixels,
  ...
  add3DShape(
    ...
    def2: def2,
    char: _coloredString('5', colorNumber: 35),
    x_rotation_on_y: x_rotation_on_y * y_rotation_on_x / 120,
    y_rotation_on_x: y_rotation_on_x * x_rotation_on_y / 120,
    z_rotation_on_y: z_rotation_on_y,
    rotated_on_x: rotated_on_x,
    rotated_on_y: rotated_on_y,
    framPixels: framPixels,
  ...
  //   def1: def1,
  //   def2: def2,
  //   x_rotation_on_y: x_rotation_on_y - 45,
  //   y_rotation_on_x: x_rotation_on_y - 45,
  //   z_rotation_on_y: z_rotation_on_y,
  //   rotated_on_x: rotated_on_x,
  //   rotated_on_y: rotated_on_y,
  //   framPixels: framPixels,
  ...
  //   def1: def1,
  //   def2: def2,
  //   char: _coloredString('4', colorNumber: 34),
  //   x_rotation_on_y: y_rotation_on_x - 60,
  //   y_rotation_on_x: x_rotation_on_y - 60,
  //   z_rotation_on_y: z_rotation_on_y,
  //   rotated_on_x: rotated_on_x,
  //   rotated_on_y: rotated_on_y,
  //   framPixels: framPixels,
  ...
  //   def1: def1,
  //   def2: def2,
  //   char: _coloredString('3', colorNumber: 33),
  //   x_rotation_on_y: x_rotation_on_y - 90,
  //   y_rotation_on_x: x_rotation_on_y - 90,
  //   z_rotation_on_y: z_rotation_on_y,
  //   rotated_on_x: rotated_on_x,
  //   rotated_on_y: rotated_on_y,
  //   framPixels: framPixels,
  ...
  //   x_rotation_on_y: y_rotation_on_x - 120,
  //   y_rotation_on_x: x_rotation_on_y - 120,
  //   z_rotation_on_y: z_rotation_on_y,
  //   rotated_on_x: rotated_on_x,
  //   rotated_on_y: rotated_on_y,
  //   framPixels: framPixels,
