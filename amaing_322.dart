...
void main(List<String> args) {
  ...
  try {
    ...
    for (var i = 0; i < (loops ??= 4400); i++) {
      ...
      if (z_rotation_value < 180 && z_clamping) {
        z_rotation_value++;
      } else if (z_rotation_value <= 180) {
        z_clamping = false;
      ...
      rotat_on_x(y, d) {
        ...
        var val = math.sin(y) * math.cos(f) * math.tan(f);
        return val;
      }
      ...
      xx(y, d) {
        var f = d *
            .0088; // this ".00875 ~ " must be for to know the shape hade rotated 180 DEG around x axis
        // var val = (math.tan(y) + math.cos(f)) * math.cos(y) + math.tan(f);
        var val = math.cos(y) * math.sin(f) * math.tan(f);
        return val;
      }
      ...
      yy(y, d) {
        var f = -d *
            .0088; // this ".00875 ~ " must be for to know the shape hade rotated 180 DEG around x axis
        // var val = (math.tan(y) + math.cos(f)) * math.cos(y) + math.tan(f);
        var val = math.sin(y) * math.cos(f) * math.tan(y);
        return val;
      }
      ...
      zz(y, d) {
        var f = d *
            .0088; // this ".00875 ~ " must be for to know the shape hade rotated 180 DEG around x axis
        // var val = (math.tan(y) + math.cos(f)) * math.cos(y) + math.tan(f);
        var val = math.cos(y) * math.sin(f) * math.tan(y);
        return val;
      }
